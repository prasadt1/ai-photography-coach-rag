...
---
---
If you are looking for an agentic Gemini‑powered implementation (multi‑agent coaching), that project has been moved to a separate repository to keep this repository focused on the RAG workflow. See your `ai-photography-coach-agents` repository for the agentic implementation.
